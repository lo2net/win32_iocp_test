...
// 
// Author: 
// Created: 2016/6/24 星期五 16:07:28
// Last-Updated: 2016/6/27 星期一 15:28:18
//           By: 10034491
// 
//     Update #: 7
// 
...
{  
    ...
    //addrSrv.sin_addr.S_un.S_addr = inet_addr("10.8.20.39");
...
{  
    while(1){     
        char recvBuf[300];  
        int recv_len = recv(sockClient, recvBuf, 200, 0);
        if (0==recv_len)
        {
